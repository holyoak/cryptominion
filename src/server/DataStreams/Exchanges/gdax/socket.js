...
class WebsocketClient extends EventEmitter {
  constructor (
    ...
    super()
    this.productIDs = Utils.parseProductIDs(productIDs)
    console.log(chalk.hex(color)('fetching GDAX markets: '))
    console.log(chalk.hex(color)('--> ') + JSON.stringify(productIDs))
    ...
    console.log(chalk.hex(color)('subscribing to GDAX channels:'))
    console.log(chalk.hex(color)('--> ') + JSON.stringify(channels))
    this.auth = auth || {}
